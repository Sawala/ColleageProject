...
<div id="SubPage">
	<div id="LeftSide">
  	...
  	<div id="EachContent">
		<br><div class="subjectDiv">經營理念</div>
		<p class="title">讓大家知道，有一個人很用心地在照顧棗子</p>
		<p class="titleDiv" style="margin: 0 20px 5px 20px;">張家蜜棗堅持使用自然工法栽種水果，替消費者的健康把關</p>
		<p align="left" style="margin: 0 30px 0 20px; line-height: 180%;">
		<img src="images/photo/IMG_1588.jpg" width="220" height="176" style="float: left; margin: 0 10px 0 0px;"/>
		　　果園使用自家製成的有機肥，使用黃豆和動物排泄物發酵，不使用化學肥料。使用草生培養，讓草類自然生長，每兩星期以人工割草機割草，取代農藥的使用，符合自然工法。以人工搭建支架，在開花時期將網子覆蓋在架上，防止果蠅和鳥類啄食，雨天過後會使用鹼性液體清洗果樹樹葉表面，使葉面光滑，增加果樹光合作用的效率。
		</p>
		<p class="titleDiv" style="margin: 5px 30px 5px 20px;"><br><br>由於對鹽埔這片土地的熱愛，並深知自然環境永續發展的重要性，使我們更加珍惜這片土地</p>
		<p align="left" style="margin: 0 30px 0 20px; line-height: 180%;">
		<img src="images/photo/IMG_1597.jpg" width="220" height="176" style="float: left; margin: 0 10px 0 0px; "/>
		<br>　　對於農業的喜愛，使得張家蜜棗在果園管理上能比別人投入更多，棗樹的管理上也格外用心注意健康情形。果實的品質，田間環境的狀況，在無形中實踐自然的理念。</p>
</div>
</div>
