...
<div id="Logo">
	<a href="index.php"><img class="thumb" src="images/LOGO.jpg"/></a>
</div>
<div id="Menu">
   <ul>
...
<div id="SubPage">
	...
	<div id="EachContent">
		<br><div class="subjectDiv">購物流程</div>
		<img src="images/shopping-process.jpg" alt="" style="margin-left:3px;">
		<div class="processinfo" style="float:left;">
			<img src="images/image001.jpg" alt="" width="350" height="330">
			<div class="titleDiv">1、加入/登入會員：</div>
			<p align="left" style="font-size: 12pt; ">　　在訂購商品之前，請先成為本網站的會員(加入會員不需支付任何的費用)，成為我們的會員之後，您可以非常容易的選購本網站的商品以及享有相關服務。<br><br><br><br><br><br><br><br></p>
			<div align="right"><a href="process_2.php">下一步》</a></div>
		</div>
	</div>
</div>
