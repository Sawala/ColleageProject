...
<div id="SubPage">
	<div id="LeftSide">
  	...
  	<div id="EachContent">
		<br>
		<div class="subjectDiv">景點介紹</div>
		<div class="titleDiv">葉家古厝</div>
		<div align="left" style="font-size: 13pt; margin: 10px 20px 10px 20px;">
			<img src="images/landmark5.jpg" width="300" height="215" style="float: left">
			　　葉家古厝由葉瑞青老先生興建於日本大正年間（約民國初年），葉老先生在日本時代，以漢人身分擔任鹽埔庄長，建造了這座堂皇凝麗的合院。所用建材、裝飾全是昔日遠從南洋、福建、荷蘭等地區引進，聘請福建來的師傅施工。可以想見葉家當年執一方牛耳的盛況。傳承至現任屏東縣議員葉明博先生，熱心為謀鄉民福利，不負地方望族之美譽。
		</div>
		<div class="subjectDiv"></div>
		<div class="titleDiv">三地門</div>
		<div align="left" style="font-size: 13pt; margin: 10px 20px 10px 20px;">
		<img src="images/landmark6.jpg" width="300" height="215" style="float: left">
		　　三地門鄉擁有得天獨厚的美景，青翠山巒、蜿蜒溪流，保有排灣族及魯凱族的文化資產。原地名的排灣語為音斯笛摩兒，清朝時期漢人北移開墾時稱之為山豬毛，光復後改稱山地鄉，1992年8月更名為三地門鄉。<br>&nbsp &nbsp &nbsp &nbsp在三地門鄉，您可以欣賞大津瀑布的美，在賽嘉露營區遊玩，到部落遺址尋幽訪古，享受原住民特色餐飲。
		</div>
		<div style="clear:both; float:right; margin-right:30px;">
			<a href="landmark_2.php"><img src="images/goleft.png" style="border: 0px;"/></a>
		</div>
	</div>
</div>
