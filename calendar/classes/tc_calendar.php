...
if((defined("L_LANG") && L_LANG != "en_US" && L_LANG != "zh_TW") || isset($language) && $language != "en_US") include_once("calendar/lang/calendar.".(isset($language) ? $language : L_LANG).".php");
include_once("calendar/lang/localization.lib.php");
...
require_once('calendar/classes/tc_date.php');
...
class tc_calendar{
	...
	function writeCalendarContainer(){
		...
		echo("<IFRAME id=\"".$this->objname."_frame\" src=\"".$this->path."calendar/calendar_form.php".$paramStr."\" frameBorder=\"0\" scrolling=\"no\" allowtransparency=\"true\" width=\"100%\" height=\"100%\" style=\"z-index: 100;\"></IFRAME>");
		echo("</div>");
	}
