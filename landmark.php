...
<div id="SubPage">
	<div id="LeftSide">
  	...
  	<div id="EachContent">
		<br><div class="subjectDiv">景點介紹</div>
		<div class="titleDiv">隘寮溪河堤車道</div>
		<div align="left" style="font-size: 13pt; margin: 10px 20px 10px 20px;">
			<img src="images/landmark1.jpg" width="300" height="215" style="float: left">
			　　隘寮溪河堤車道全長約24公里，東起隘寮、南至九如，共分為隘寮、鹽埔、里港、九如四個區段，沿途可一路欣賞隘寮溪河岸風光，由當地居民打造的綠色長城，在里港路段另外設置了花卉草木闢建的河堤公園，再往前走去可看見一片綠油油的遼闊草地，其他像是水門碰坑、過江河堤公園、里港老街、佛光山與斜張橋都是會沿途經過的特色景點。
		</div>
		<div class="subjectDiv"></div>
		<div class="titleDiv">大鴕家</div>
		<div align="left" style="font-size: 13pt; margin: 10px 20px 10px 20px;">
			<img src="images/about-ostrich3.jpg" width="300" height="215" style="float: left">
			　　大鴕家觀光休閒農場，不僅可餵食鴕鳥園，是一座知性之旅的觀光休閒農場，多元的娛樂餐廳部設有鴕鳥餐廳、卡拉ＯＫ、茶坊、咖啡廳、藝術的鴕鳥蛋彩繪，還有鴕鳥精品門市部有皮件、皮包、皮鞋、美容部有化妝品、手工皂、精油、保健部等各種鴕鳥保健品。
		</div>
		<div style="clear:both; float:right; margin-right:30px;">
			<a href="landmark_2.php"><img src="images/goright.png" style="border: 0px;"/></a>
		</div>
	</div>
</div>
