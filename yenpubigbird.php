...
<div id="SubPage">
	<div id="LeftSide">
  	...
  	<div id="EachContent">
		<br><div class="subjectDiv">在地牧場</div>
		<div class="titleDiv">大鴕家</div>
		<p align="left" style="font-size: 13pt; margin-left:30px; margin-right:30px; line-height: 180%;">
			大鴕家觀光休閒農場是由台灣鴕鳥運銷合作社創社理事主席楊明謀先生成立，是台灣最大最專業鴕鳥觀光園區，鴕鳥年產量一萬隻，提供南台灣最專業鴕鳥成長過程生態教學。
		</p>
		<div class="titleDiv">台糖</div>
		<p align="left" style="font-size: 13pt; margin-left:30px; margin-right:30px; line-height: 180%;">
			台糖公司為求突破，近年將位於鹽埔東海豐的養牛場，引進大量鴕鳥，成立鴕鳥觀光休閒園區，園區佔地12公頃、目前有近900隻鴕鳥。
		</p>
    </div>
</div>
