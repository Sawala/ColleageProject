...
<div id="SubPage">
	<div id="LeftSide">
  	...
  	<div id="EachContent">
		<br><div class="subjectDiv">當季水果</div>
		<blockquote>
			<p class="title">蜜棗</p>
			<p><img src="images/douknowfruit1.jpg" width="200" height="149"/><br>果皮薄、果粒大，果實質脆多汁，含豐富的維生素C、B1、B2，也富含鉀、鈣、鎂等礦物質；除了滿足味蕾，蜜棗也是營養豐富的優質水果。要買要快唷!!</p>
		</blockquote>
	</div>
</div>
