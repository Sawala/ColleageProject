...
<div id="SubPage">
	...
	<div class="titleDiv">歷史鹽埔 - 鹽埔的位置</div>
		<div id="photoContent"> <iframe src="web/IanpuMap/IanpuMap.html" name="IanpuMap" width="540px" marginwidth="0" height="330" marginheight="0" scrolling="no" frameborder="0" id="IanpuMap"></iframe> </div>
        <div class="titleDiv">鹽埔產業</div>
	<p align="left" style="font-size: 13pt; margin-left:30px; margin-right:30px; line-height: 160%;"><img src="images/industry1.jpg" width="150" height="150" style="float: left">　　從古至今鹽埔是一個典型的農村，居民大多以務農為主。但為因應經濟結構的轉型，當地農民開始改種高價值的果樹及花卉。
在漁牧業方面，牧業則以養豬、雞、鴨居多，養牛、羊為副業；水產養殖以長腳大蝦（泰國蝦）、吳郭魚、鱸魚、鱔魚為主，也是他們主要的經濟來源之一。</p>
	
	<div style="float:right; margin-right:30px;">
		<a href="intro.php"><img src="images/goleft.png" style="border: 0px;"/></a>
