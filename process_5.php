...
<div id="SubPage">
	...
	<div id="EachContent">
		...
		<div class="processinfo" style="float:left;">
			<img src="images/image005.jpg" alt="" width="350" height="330">
			<div class="titleDiv">5、結帳：</div>
			<p align="left" style="font-size: 12pt;">　　填完訂購資料後，請務必選擇您欲選擇之付款方式：貨到付款或提款機(ATM)匯款轉賬。按下「送出訂購單」後即完成交易。<br><br><br><br><br><br><br><br></p>
			<div align="right"><a href="process_4.php">《上一步</a>　　<a href="process_6.php">下一步》</a></div>
		</div>
	</div>
</div>
