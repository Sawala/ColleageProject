...
<div id="SubPage">
	<div id="LeftSide">
  	...
  	<div id="EachContent">
		...
		<div class="titleDiv">果農之家採水果</div>
		<div align="left" style="font-size: 13pt; margin: 10px 20px 10px 20px;">
			<img src="images/farm.jpg" width="300" height="215" style="float: left">
			　　位於大鴕家旁，果農有提供蜜棗以及蓮霧供遊客採水果。
		</div>
		<div class="subjectDiv"></div>
		<div class="titleDiv">朝鳳宮</div>
		<div align="left" style="font-size: 13pt; margin: 10px 20px 10px 20px;">
			<img src="images/landmark4.jpg" width="300" height="215" style="float: left">
			　　朝鳳宮位在北村，是鹽埔鄉最古的廟宇，供奉天上聖母，亦是鹽埔媽祖廟，創建於清道光年間。
		</div>
		<div style="clear:both; float:right; margin-right:30px;">
			<a href="landmark.php"><img src="images/goleft.png" style="border: 0px;"/></a>
			<a href="landmark_3.php"><img src="images/goright.png" style="border: 0px;"/></a>
		</div>
	</div>
</div>
