...
<blockquote>
<p class="subtitle">營養價值</p>
<p align="left">　　果實質脆多汁，含豐富的維生素C、B1、B2，也富含鉀、鈣、鎂等礦物質，是營養豐富的優質水果。</p>
<p class="subtitle">鹽埔地區蜜棗特點</p>
<ol>
  <li align="left" style="line-height: 160%;">當地氣候溫和，隘寮溪水質好，流經鹽埔灌溉果園；當地土壤砂石含量較多，使得排水比其他地方優良許多。</li>
  <li align="left" style="line-height: 160%;">鹽埔地區的果農，全台經營棗子歷史最悠久、最專業、經驗最豐富，自行研發出許多品種，全國最好吃的棗子都在鹽埔。</li><br />
</ol>
    <p class="subtitle">如何保存蜜棗？</p>
    <p>建議蜜棗買回家之後，使用塑膠袋包裝好以避免露出蜜棗表皮，接著放置冰箱冷藏，如此約可保存2個星期。</p>
<br>

    <div align="center"><a href="fruitdic_1.php">上一頁</a>　　<a href="fruitdic_3.php">下一頁</a></div>
</div>
</div>
