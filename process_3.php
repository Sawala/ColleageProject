...
<div id="SubPage">
	...
	<div id="EachContent">
		...
		<div class="processinfo" style="float:left;">
			<img src="images/image003.jpg" alt="" width="350" height="330">
			<div class="titleDiv">3、確認您的購物車：</div>
			<p align="left" style="font-size: 12pt;">　　當您完成選購商品的步驟後，請點選您的購物車連結，並且確認您所選的商品皆在購物車上，確認無誤後即可點選「前往結帳」。<br><br><br><br><br><br><br><br></p>
			<div align="right"><a href="process_2.php">《上一步</a>　　<a href="process_4.php">下一步》</a></div>
		</div>
	</div>
</div>
