...
<div id="SubPage">
	...
	<div id="EachContent">
		...
		<div class="processinfo" style="float:left;">
			<img src="images/image006.jpg" alt="" width="350" height="330">
			<div class="titleDiv">6、E-mail確認訂購商品與查詢訂單：</div>
			<p align="left" style="font-size: 12pt;">　　在您完成訂購程序，隨後約1～5分鐘即會將您的訂購清單透過系統寄送一封 E-mail 至您的電子信箱，收到這封郵件代表您的訂購已完成，我們會盡快處理您的訂單。<br><br><br><br><br><br><br><br></p>
			<div align="right"><a href="process_5.php">《上一步</a>　　　　　　</a></div>
		</div>
	</div>
</div>
