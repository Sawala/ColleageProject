...
<div id="SubPage">
	<div id="LeftSide">
  	...
  	<div id="EachContent">
		<br><div class="subjectDiv">鹽埔藝廊</div>
		<p>
		<script type="text/javascript">
		document.getElementById('picture').onmouseover=function()
		{
			this.setAttribute('src','images/test2.JPG');
		}
		document.getElementById('picture').onmouseout=function()
		{
			this.setAttribute('src','images/scenery1.JPG');
		}
		</script>
		<iframe src="web/Scenery/Scenery.html" name="Scenery" width="650" height="450" scrolling="no" frameborder="0" style="margin-left: 4px;"></iframe>
		</p>
	</div>
</div>
