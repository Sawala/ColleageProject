...
<div id="SubPage">
	...
	<div id="EachContent">
		<br><div class="subjectDiv"><a name="#process" id="process"></a>購物流程</div>
		<img src="images/shopping-process.jpg" alt="" style="margin-left:3px;">
		<div class="processinfo" style="float:left;">
			<img src="images/image004.jpg" alt="" width="350" height="330">
			<div class="titleDiv">4、提供訂購資料：</div>
			<p align="left" style="font-size: 12pt;">　　請再次核對購買清單的品名、金額、數量是否正確無誤，並詳細填寫其餘未寫之欄位。為了讓商品迅速無誤地寄到您手中，請仔細填妥訂購資料，尤其是收件人中文姓名、電話和寄送地址。<br><br><br><br><br><br><br></p>
			<div align="right"><a href="process_3.php">《上一步</a>　　<a href="process_5.php">下一步》</a></div>
		</div>
	</div>
</div>
